...
export interface UIActions {
  ...
  setShowNameManagerDialog: (show: boolean) => void
...
export function createUIActions(
  ...
  return {
    ...
    setShowNameManagerDialog: (show) => set((s) => { s.showNameManagerDialog = show }),
