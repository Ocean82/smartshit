  ...
  const menus: Record<MenuId, { label: string; items: MenuItem[] }> = {
    ...
    view: {
      ...
      items: [
        ...
        { label: 'Freeze Top Row', action: () => { useStore.getState().setFreeze(1, 0); setOpenMenu(null) } },
        { label: 'Freeze First Column', action: () => { useStore.getState().setFreeze(0, 1); setOpenMenu(null) } },
